...
export const StateCompleteImages        = "completeImages";
...
export const StatePendingPlays          = "pendingPlays";
export const StatePlayerBoost           = "playerBoost";
export const StatePlayersBoost          = "playersBoost";
export const StatePlaysPerImage         = "playsPerImage";
export const StatePlaysRequiredPerImage = "playsRequiredPerImage";
...
export const StateTotalPlayerTags       = "totalPlayerTags";
